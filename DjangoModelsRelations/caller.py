...
# 01. Test code for 'The Lecturer and The Subject' task
# -------------------------------------------------
...
# 02. Test code for 'The Student' tasks
# -----------------------------------
...
student1.subjects.add(subject1, subject2, through_defaults={'enrollment_date': '2001-05-20'})
student2.subjects.add(subject1, subject2, subject3, through_defaults={'enrollment_date': '2001-06-30'})
...
# 03. Test code for 'The Enrollment' task
# ---------------------------------------
...
# 04. Test code for 'The Lecturer Profile' task
# ---------------------------------------------
