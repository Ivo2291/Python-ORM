...
# 01. Real Estate Listing task with custom manager -> Test code:
# -------------------------------------------------------------
...
# 02. Video Games Library task with custom manager -> Test code:
# -------------------------------------------------------------
...
# 03. Shopaholic Haven task -> Test code:
# --------------------------------------
